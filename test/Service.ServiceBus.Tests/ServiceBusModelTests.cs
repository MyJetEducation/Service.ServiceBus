...
namespace Service.ServiceBus.Tests
{
	public class ServiceBusModelTests
	{
		private static readonly (Type type, object model)[] TestBusModels =
		{
			...
			(typeof (ClearEducationProgressServiceBusModel), new ClearEducationProgressServiceBusModel {UserId = "08c6f0ac-2a1b-4970-b0a2-17d5c945a293", Tutorial = EducationTutorial.Economics, Task = 1, Unit = 1, ClearUiProgress = true}),
