...
namespace Service.ServiceBus.Tests
{
	public class ServiceBusModelTests
	{
		private static readonly (Type type, object model)[] TestBusModels =
		{
			...
			(typeof (SetProgressInfoServiceBusModel), new SetProgressInfoServiceBusModel {UserId = "7568c9bb-438a-4d80-ab84-d8d6763d7f7f", Duration = TimeSpan.Zero, IsRetry = true, SetUserProgress = true, Task = 1, Tutorial = EducationTutorial.Economics, Unit = 1, Progress = 80, TutorialProgress = 90}),
